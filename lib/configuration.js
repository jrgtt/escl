const configuration = require('cosmiconfig')('escl');
 ...
 *
 * To pass those configuration create a `.esclrc` (supported in
 * different extensions such as `js`, `yaml`, `json`) file within your
 * project or add a key named `escl` to your package.json.
 *
